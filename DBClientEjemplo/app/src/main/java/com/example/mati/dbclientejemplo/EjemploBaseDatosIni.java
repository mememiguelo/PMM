...
public class EjemploBaseDatosIni extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView nombreIntro= (TextView)findViewById(R.id.nombre);
        TextView numeroIntro= (TextView)findViewById(R.id.numero);
...
*/
                ...
                if (c.moveToFirst()) {
        			...
        			do {
                        ...
                        //System.out.println(nombreCli + " - " + telefonoCli);
                        datos += nombreCli + "-" + telefonoCli + "\n";
                        nombreIntro.setText(datos);
                        //numeroIntro.setText(telefonoCli);
        			} while (c.moveToNext());
        		}
